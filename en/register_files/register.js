...
let email, password, plan, keywords;
...
function secondComp() {
  ...
  if (basicPlan) {
    plan = "Basic"
    icDiv.innerHTML = '<div class="input-group flex-nowrap"><span class="input-group-text" id="addon-wrapping">#</span><input type="text" class="form-control keyword" placeholder="Keyword" aria-describedby="addon-wrapping" required></div>';
  } else {
    plan = "Pro"
    icDiv.innerHTML =
      '<div class="input-group flex-nowrap"><span class="input-group-text" id="addon-wrapping">#</span><input type="text" class="form-control keyword" placeholder="Keyword #1" aria-describedby="addon-wrapping" required></div>' +
      '<div class="input-group flex-nowrap" style= "margin-top: 3%;"><span class="input-group-text" id="addon-wrapping">#</span><input type="text" class="form-control keyword" placeholder="Keyword #2" aria-describedby="addon-wrapping" required></div>' +
      '<div class="input-group flex-nowrap" style= "margin-top: 3%;"><span class="input-group-text" id="addon-wrapping">#</span><input type="text" class="form-control keyword" placeholder="Keyword #3" aria-describedby="addon-wrapping" required></div>' +
      '<div class="input-group flex-nowrap" style= "margin-top: 3%;"><span class="input-group-text" id="addon-wrapping">#</span><input type="text" class="form-control keyword" placeholder="Keyword #4" aria-describedby="addon-wrapping" required></div>' +
      '<div class="input-group flex-nowrap" style= "margin-top: 3%;"><span class="input-group-text" id="addon-wrapping">#</span><input type="text" class="form-control keyword" placeholder="Keyword #5" aria-describedby="addon-wrapping" required></div>';
  }

  const button = document.createElement("a");
  button.style = "margin-top: 3%; margin-left: 24%; width: 240px; height: 40px;";
  button.className = "btn btn-primary";
  button.textContent = "Next";
  ...
  await fetch("http://25.33.228.221:3000/register", {
    ...
    if (res.status === 200) {
      ...
      if (res.error) {
        ...
        answer = confirm("That user exists. Do you want to login?");
        if (answer) {
          window.location.replace("login.html");
        }
      }
